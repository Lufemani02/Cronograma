...
exports.obtenerTareasPorDepartamento = exports.obtenerMiembrosPorDepartamento = exports.obtenerDatosDelLider = void 0;
const db_1 = __importDefault(require("../config/db"));
const obtenerDatosDelLider = async (req, res) => {
    try {
    ...
    `, [usuarioId]));
        ...
        const deptoIds = deptosRows.map((d) => d.id);
        // 2. Obtener miembros de esos departamentos
        const [miembrosRows] = await db_1.default.query(`
    ...
    `, [deptoIds]);
        ...
        const [tareasRows] = await db_1.default.query(`
...
exports.obtenerDatosDelLider = obtenerDatosDelLider;
